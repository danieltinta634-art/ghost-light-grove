# Ghost Light Grove — Story Spoiler Doc (draft 1)

> PRIVATE design document. Plain statements of what is TRUE in the world,
> so all dialogue/clues/events can be written without contradiction.
> Canon = decided by the designer. Open = not yet decided. Suggestions = Claude's, not canon.

---

## The World (canon)

- Ghost Light Grove is a **veiled region of the mainland** locked in **perpetual night**. Outside the veil, the ordinary world has normal days; ordinary people never find the way in.
- **The Grove draws those who need it.** Outcast supernatural folk feel a pull — a dream, a road that shouldn't be there. The town's population is curated by need; every resident once had nowhere else.
...
- **Wilcox has let no one into the manor since** — years of turning the whole town away. He admits the player **because of the pendant**.
- The one person who could have explained everything is the person whose death brought the player here.
...
- **Myra & Alice's monster ranch/sanctuary** sits where the forest meets the manor cliff — it **hugs the manor cliff on its LEFT (west) side, at the forest's edge.** (Between the safe Woods and the foot of the cliff — the monster hunter lives at the boundary, as ever.)
...
- **Victor "argues with himself" — literally.** He's involuntarily and unpredictably possessed by a spirit, a side-effect of his own exposure to concentrated ghost light in the lab (started *after* he arrived — an occupational hazard, not his reason for coming). This is what led him to ghost light therapy in the first place: firsthand contact with a soul that wouldn't move on sparked the compassion + curiosity behind the uplifts. The spirit is blunt and comedically fixated on something mundane (exact fixation TBD) — genuinely funny, though the loss of control unsettles Victor. **Clementine knows and is completely unbothered.** **Who the spirit actually is is the mystery:** more than an ordinary unreaped backlog soul (deliberately more mysterious — a thread, not yet answered), meant to unravel through Victor's friendship-track content rather than be explained upfront. Whether ordinary townsfolk read this as a literal possession or just "Victor being eccentric" is open.
