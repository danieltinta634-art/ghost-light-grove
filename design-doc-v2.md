...
**World/Systems:** tide names & flavors (proposed, unapproved) · scythe upgrade source · cave floor structure · likes/dislikes pass · Rowan's role (last marriage candidate without one — Minori's is now fully defined) · arrival-story one-liners per resident · whether ghost light doubles as reaper-rank XP (see Economy).
